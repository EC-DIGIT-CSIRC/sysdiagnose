...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="sysdiag", description="Sysdiagnose Analysis Framework - parsing and analysis"
    )
    # available for all
    parser.add_argument(
        "-c",
        ...
        required=False,
        default="all",
        help='ID of the case, comma-separated list of IDs, or "all" for all cases (default)',
    )
    parser.add_argument(
        "-l",
        "--log",
        ...
        help="Enables logging level (DEBUG, INFO, WARNING, ERROR, CRITICAL)",
    )
    ...
    analyse_parser.add_argument(
        "analyser",
        help='Name of the analyser, "all" for running all analysers, or "list" for a listing of all analysers',
    )
    analyse_parser.add_argument(
        ...
        for case_id in case_ids:
            ...
            for i, parser in enumerate(parsers_list, 1):
                ...
                try:
                    ...
                    logger.warning(
                        f"Parser '{parser}' is not implemented yet, skipping",
