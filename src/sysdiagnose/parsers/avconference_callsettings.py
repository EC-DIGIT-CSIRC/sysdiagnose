...
class AvConferenceCallSettingsParser(BaseParserInterface):
    ...
    def get_log_files(self) -> list:
        log_files_globs = ["logs/AVConference/*-CallSettings.calldump.gz"]
        log_files = []
    ...
    def parse_file_content(self, file_content: bytes, fname: str) -> list:
        ...
        for line in lines:
            ...
            event = Event(datetime=timestamp, message=message, module=self.module_name, timestamp_desc=self.module_name)
