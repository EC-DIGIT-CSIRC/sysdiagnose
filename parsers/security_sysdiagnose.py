...
parser_description = "Parsing security-sysdiagnose.txt file containing keychain information"
    ...
    with open(log_file, "r") as f:
        ...
        for line in f:
            ...
            if line == '':
                ...
                process_buffer(buffer, buffer_section, json_result)
...
def process_buffer(buffer: list, section: str, json_result: dict):
    ...
    if function_name in globals():
        globals()[function_name](buffer, json_result)
    else:
        print(f"ERROR: Function {function_name} not found in the globals.")
