...
class TestParsersPs(SysdiagnoseTestCase):
    ...
    def test_ps_exclude_known_goods(self):
        processes = [{"command": "good", "pid": 1}, {"command": "bad", "pid": 2}, {"command": "unknown", "pid": 3}]
        known_good = [{"command": "good", "pid": 1}]
        expected_result = [{"command": "bad", "pid": 2}, {"command": "unknown", "pid": 3}]
