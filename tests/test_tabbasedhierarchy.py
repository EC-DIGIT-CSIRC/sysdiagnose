    ...
    def test_remotectldumpstateblock(self):
        ...
        expected_result = {
            "Local device": {
                ...
                "Messaging Protocol Version": "3",
                "Product Type": "iPhone9,3",
                "Properties": {"AppleInternal": "false", "CPUArchitecture": "arm64"},
                "Services": [
                    "com.apple.remote.installcoordination_proxy",
                    "com.apple.bluetooth.BTPacketLogger.shim.remote",
                ],
            ...
            "Found foo": {
                ...
                "Product Type": "MacBookPro15,1",
                "Messaging Protocol Version": "3",
                "Heartbeat": ["0 heartbeats sent, 0 received"],
                "Properties": {
                    "AppleInternal": "false",
                    "CPUArchitecture": "x86_64h",
                    "EncryptedRemoteXPCPopulatedOIDs": {"0": "1.2.840.113635.100.6.83", "1": "1.2.840.113635.100.6.84"},
                },
                "Services": {
                    "com.apple.osanalytics.logRelay": {"Properties": {"UsesRemoteXPC": "true"}},
                    "foobar": "",
                    "ssh": {"Properties": {"Legacy": "true"}},
                },
                "Local Services": [
                    "com.apple.fusion.remote.service",
                    "com.apple.mobile.insecure_notification_proxy.shim.remote",
