...
class TestParsersSpindumpnosymbols(SysdiagnoseTestCase):
    def test_parse_spindump_ns(self):
        for case_id, _case in self.sd.cases().items():
            with self.subTest(case_id=case_id, ios_version=_case.get("ios_version")):
                p = SpindumpNoSymbolsParser(self.sd.config, case=_case)
        ...
        expected_result = {
            ...
            "images": [
                ...
                },
                {
                    ...
                    "end": "0x102ca3fff",
                    "image": "dyld",
                    "uuid": "58AB16CE-D7E0-32D3-946D-4F68FB1A4A17",
                    "path": "/cores/dyld",
                },
                {
                    "start": "0x180a95000",
                    ...
                    "uuid": "717D70C9-3B8E-3ABC-AE16-050588FC3EE8",
                ...
                },
                {
                    ...
                    "end": "0x18248dfff",
                    "image": "Foundation",
                    "uuid": "C3A840E1-0D11-32A3-937F-7F668FFB13F0",
                ...
                },
                {
                    ...
                    "uuid": "D3BAC787-09EE-3319-BE24-4115817391E2",
    ...
    def test_parse_thread(self):
        ...
        expected_result = {
            ...
            "dispatch_queue": "com.apple.main-thread",
            "priority": "31",
            "cputime": "0.005s (4.2M cycles, 1986.9K instructions, 2.14c/i)",
            "loaded": [
        ...
        expected_result = {
            "thread": "0x84",
            "thread_name": "IOConfigThread_'foobar'",
            "priority": "80",
            "cputime": "<0.001s",
            "loaded": [{"library": "kernel", "int": "850132", "hex": "0xffffff80002df8d4", "status": "running"}],
        }
        result = SpindumpNoSymbolsParser.parse_thread(lines)
        self.assertDictEqual(expected_result, result)
