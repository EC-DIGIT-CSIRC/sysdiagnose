...
class TestParsersCrashlogs(SysdiagnoseTestCase):
    def test_parse_crashlogs(self):
        for case_id, _case in self.sd.cases().items():
            with self.subTest(case_id=case_id, ios_version=_case.get("ios_version")):
                p = CrashLogsParser(self.sd.config, case=_case)
    ...
    def test_split_thread(self):
        lines = ["0   libsystem_kernel.dylib        	0x0000000123456789 0x123456000 + 123456"]
        expected_results = [
            {
                "id": "0",
                "image_name": "libsystem_kernel.dylib",
                "image_base": "0x0000000123456789",
                "image_offset": "0x123456000",
                "symbol_offset": "123456",
            }
        ]
    ...
    def test_split_binary_images(self):
        ...
        expected_results = [
            {
                "image_offset_start": "0x123456000",
                "image_offset_end": "???",
