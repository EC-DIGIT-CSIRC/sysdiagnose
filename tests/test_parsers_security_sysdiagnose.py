    ...
    def test_get_security_sysdiagnose(self):
        for case_id, _case in self.sd.cases().items():
            with self.subTest(case_id=case_id, ios_version=_case.get("ios_version")):
                p = SecuritySysdiagnoseParser(self.sd.config, case=_case)
    ...
    def test_process_buffer_keychain_state(self):
        ...
        expected_output = {
            ...
            "events": [
                {
                    "module": "TestModule",
                    "datetime": "2023-05-24T19:56:14.000000+00:00",
                    "timestamp_desc": "rapport: entry creation time",
                    "message": "rapport iPhone - com.apple.rapport",
                    "data": {
                        "section": "rapport",
                        "attributes": {
                            "accc": "<SecAccessControlRef: ck>",
                            "acct": "69AAAFE9-A7FA-4BF3-922E-A14C33F11924",
                            "agrp": "com.apple.rapport",
                            "cdat": "2023-05-24 19:56:14 +0000",
                            "gena": "{length = 33, bytes = 0xe3456d6f 64656c49 6950686f 6e65392c ... 6973696f 6e494409 }",
                            "invi": "1",
                            "labl": "iPhone",
                            "mdat": "2023-05-24 19:56:14 +0000",
                            "musr": "{length = 0, bytes = 0x}",
                            "pdmn": "ck",
                            "sha1": "{length = 20, bytes = 0x1490ff273a003ef4089c46beb3731eb04754c7e5}",
                ...
                },
                {
                    "module": "TestModule",
                    "datetime": "2023-05-24T19:56:14.000000+00:00",
                    "timestamp_desc": "rapport: entry modification time",
                    "message": "rapport iPhone - com.apple.rapport",
                    "data": {
                        "section": "rapport",
                        "attributes": {
                ...
                },
                {
                    ...
                    "data": {
                        ...
                        "attributes": {
                            ...
                            "build": "19H349",
                            "overallScore": "0",
                            "timeSinceLastReset": "127",
                            "rootUsages": "( foo, bar )",
                            "errorDomain": "MITMErrorDomain",
                            "modelid": "iPhone9,3",
                            "errorCode": "0",
                        },
                    },
