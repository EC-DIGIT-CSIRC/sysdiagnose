...
class TestMisc(SysdiagnoseTestCase):
    ...
    def test_load_plist_with_json_file(self):
        result = misc.load_plist_as_json("tests/testdata/iOS15/sysdiagnose_2023.05.24_13-29-15-0700_iPhone-OS_iPhone_19H349/logs/SystemVersion/SystemVersion.plist")
        self.assertGreater(len(result), 0)
