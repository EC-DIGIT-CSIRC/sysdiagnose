...
class TestParsersWifiScan(SysdiagnoseTestCase):
    def test_parsewifiscan(self):
        for case_id, _case in self.sd.cases().items():
            with self.subTest(case_id=case_id, ios_version=_case.get("ios_version")):
                p = WifiScanParser(self.sd.config, case=_case)
    ...
    def test_parse_line(self):
        ...
        expected_results = [
            {
                "ssid": "FIRSTCONWIFI",
                "ssid_hex": "4649525354434f4e57494649",
                "bssid": "<redacted>",
                "channel": "11 (flags=0xA, 2GHz, 20MHz)",
                "cc": "FR",
                "phy": "n (0x10)",
                "rssi": "-31",
                "rsn": "(null)",
            ...
            },
            {
                ...
                "type": "11ac",
                "rssi": "-62",
                "rsn": "mcast=aes_ccm, ucast={ aes_ccm }, auths={ psk }, caps=0xc, wpa=(null), wep=no, ibss=no, ph=no, swap=no, hs20=no,",
            },
            {
                "ssid": "<unknown>",
                "security": "wpa2-personal",
                ...
                "phy": "n",
                "rssi": "-81",
                "wasConnectedDuringSleep": "0",
                "bi": "100",
                "age": "2069ms (244355645)",
            },
        ]
